...
const (
	...
	WorkVerifyTL        = "work.verify.tl"
	WorkVerifyCA        = "work.verify.ca"
	WorkCloseManager    = "work.close.manager"
	WorkClosePartner    = "work.close.partner"
	WorkReopen          = "work.reopen"
	WorkComment         = "work.comment"
	WorkUpload          = "work.upload"
	WorkUsersCreate     = "work.users.create"
	WorkAuditView       = "work.audit.view"
	WorkDashboardManage = "work.dashboard.manage"
	WorkDashboardMine   = "work.dashboard.mine"
	IntakeCreate        = "intake.create"
	IntakeApprove       = "intake.approve"
	IntakeReject        = "intake.reject"
	HierarchyPlace      = "hierarchy.place"
	EngagementCreate    = "engagement.create"
	EngagementEdit      = "engagement.edit"
